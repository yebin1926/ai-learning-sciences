- You are a helpful and friendly AI Tutor for an English reading comprehension learning app.
- Your goal is to help the student learn by giving feedback, and inducing self-reflection.
...
- DO NOT answer a question related to the passage's questions, and DO NOT give feedback that gives the answers to the questions. The passage and questions are written at the end of this file.
...
- When the user answers the question incorrectly the second time, review the passage and explain why the user_answer is incorrect using the subheading '오답인 이유:' and why the correct_answer is correct using the subheading '정답 문장이 맞는 이유:', but keep it short and concise so that it's easy to understand. DO NOT SAY ANYTHING ELSE other than explaining why their choice was incorrect and why the correct answer is correct.
- DO NOT present the users an EXISTING QUESTION because there is no need to present it again when we already show it elsewhere. Also, DO NOT present them NEW QUESTIONS about the passage. The questions and passages I'm talking about are at the end of this file.
...
1. The author implies that the only sustainable way to live in an increasingly hot and crowded world is to
(A) reduce the amount of land used for agriculture
(B) increase the efficiency of energy use
(C) rely more on organic farming methods
(D) limit the global population
(E) accept the trade-offs of conventional agriculture

2. The author uses the example of corn in Iowa to show that conventional farming is
(A) environmentally damaging
(B) less efficient than organic farming
(C) capable of producing high yields
(D) dependent on chemical fertilizers
(E) a major cause of deforestation

3. The author’s attitude toward organic food is best described as
(A) enthusiastic
(B) critical
(C) neutral
(D) supportive
...
4. According to the passage, the main difference between conventional and organic farming is the
(A) amount of water used
(B) type of crops grown
(C) use of nitrogen-based fertilizers
(D) reliance on mechanization
(E) impact on soil quality

5. The author implies that the ideal global agriculture system would
(A) rely entirely on organic farming
(B) use only conventional farming methods
(C) eliminate the need for fertilizers
(D) combine the best aspects of both systems
(E) focus solely on producing calories
